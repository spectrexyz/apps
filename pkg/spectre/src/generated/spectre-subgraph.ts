...
export type AllSpectresQuery = { readonly __typename?: 'Query', readonly spectres: ReadonlyArray<{ readonly __typename?: 'Spectre', readonly sERC20: { readonly __typename?: 'sERC20', readonly name: string, readonly symbol: string, readonly cap: string, readonly sale?: { readonly __typename?: 'Sale', readonly id: string } | null, readonly issuance?: { readonly __typename?: 'Issuance', readonly id: string } | null } }> };
...
export const useAllSpectresQuery = <
    ...
    useQuery<AllSpectresQuery, TError, TData>(
      ...
      fetcher<AllSpectresQuery, AllSpectresQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, AllSpectresDocument, variables),
      options
    );