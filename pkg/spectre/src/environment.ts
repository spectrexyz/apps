...
const env = z.object({
  ...
  VITE_CHANNELER_ADDRESS: z.string().regex(ADDRESS_RE),
  VITE_SERC721_ADDRESS: z.string().regex(ADDRESS_RE),
  VITE_ERC1155_ADDRESS: z.string().regex(ADDRESS_RE),
